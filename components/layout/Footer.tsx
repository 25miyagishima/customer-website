    ...
    <footer className="bg-[#161412] px-5 py-14 text-white md:px-8 md:py-16">
      <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
        <p className="max-w-2xl text-[18px] font-light leading-8 text-white/56 md:text-[19px]">
          Thoughtfully planned lighting environments throughout the Okanagan.
        </p>
        ...
        <p className="mt-10 max-w-2xl text-sm leading-7 text-white/28">
          Serving Penticton, Summerland, Peachland, Kelowna, West Kelowna,
          Naramata, and Osoyoos with indoor and outdoor lighting environments
          designed around atmosphere, comfort, and the way spaces are lived in.
        </p>
